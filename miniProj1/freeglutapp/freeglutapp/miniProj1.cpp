...
float red = 0.1, green = 0.5, blue = 0.0;
...
void appDrawScene() {
	...
	//
	// THIS PART IS THE LETTER M, WITH MULTIPLE TRIANGLES INSIDE A BOX/RECTANGLE
	//

		
	glColor3f(1.0, 1.0, 1.0);

	glBegin(GL_TRIANGLES); //first small triangle, lower part
	glVertex2f(-0.6, -0.5);
	glVertex2f(-0.4,-0.5);
	glVertex2f(-0.6, -0.3); 
	glEnd();

	glBegin(GL_TRIANGLES); //second small triangle
	glVertex2f(-0.2, -0.5);
	glVertex2f(0.0, -0.5);
	glVertex2f(0.0, -0.3);
	glEnd();

	glBegin(GL_TRIANGLES); //big triangle
	glVertex2f(-0.6, 0.5);
	glVertex2f(0.0, 0.5);
	glVertex2f(-0.3, 0.0);
	glEnd();

	//this part is the big blue polygon
	glColor3f(0.0f, 0.0f, 1.0f);

	glBegin(GL_POLYGON); //this is the big box
	glVertex2f(-0.9, 0.5);
	glVertex2f(0.3, 0.5);
	glVertex2f(0.3, -0.5);
	glVertex2f(-0.9, -0.5);
	...
	glBegin(GL_POLYGON); //first side of L
	glVertex2f(0.3, -0.5);
	glVertex2f(0.3, 0.5);
	glVertex2f(0.6, 0.5);
	glVertex2f(0.6, -0.5);
...
//	glColor3f(1.0f, 0.0f, 0.0f);
	...
	glBegin(GL_POLYGON);//the horizontal side of L
	glVertex2f(0.5, -0.5);
	glVertex2f(0.9, -0.5);
	glVertex2f(0.9, -0.15);
	glVertex2f(0.5, -0.15);
